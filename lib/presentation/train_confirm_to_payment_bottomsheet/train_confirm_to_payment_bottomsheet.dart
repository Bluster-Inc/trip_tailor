...
import 'controller/train_confirm_to_payment_controller.dart';

class TrainConfirmToPaymentBottomsheet extends StatelessWidget {
  TrainConfirmToPaymentBottomsheet(
    this.controller, {
    Key? key,
  }) : super(
          key: key,
  ...
  TrainConfirmToPaymentController controller;

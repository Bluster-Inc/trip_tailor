...
import 'controller/train_select_date_controller.dart';

// ignore_for_file: must_be_immutable
class TrainSelectDateScreen extends GetWidget<TrainSelectDateController> {
  const TrainSelectDateScreen({Key? key})
      : super(
          key: key,
        );
